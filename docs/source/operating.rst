[myawesometmlsolutionml-3f10-ml] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-3f10-ml] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-3f10-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39399  \-\-env VIPERVIZPORT=9689  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='smaurice'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9689/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:9689/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/myawesometmlsolutionml-3f10-ml-amd64
...
[myawesometmlsolutionml-3f10-ml] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-3f10
...
.. important::
   solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38219, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45283, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34099, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40641, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41451, HPDEHOST=127.0.1.1, HPDEPORT=44823, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44079

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4277-myawesometmlsolutionml-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-preprocess-4687-myawesometmlsolutionml-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-predict-9901-myawesometmlsolutionml-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-ml-2078-myawesometmlsolutionml-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
